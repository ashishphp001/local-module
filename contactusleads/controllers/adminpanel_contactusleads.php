...
class Adminpanel_contactusleads extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('contactusleads_model', 'module_model');      // MODULE MODEL
        $this->main_tpl = 'adminpanel/contactusleads_tpl';                 // MODULE MAIN VIEW  
        $this->module_url = base_url() . 'adminpanel/contactusleads/';               // MODULE URL
    ...
    public function index() {
        ...
        $this->viewData['contactusleadsTab'] = true;
    ...
    public function download_pdf() {
        ...
        $data = file_get_contents(base_url() . 'upimages/contactusleads/' . $file);
