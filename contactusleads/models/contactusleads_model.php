...
class contactusleads_model extends CI_Model {
    ...
    function Generateurl() {
        ...
        $this->hurlwithpara = $this->PageName . '?' . 'hpagesize=' . $this->PageSize . '&hnumofrows=' . $this->NumOfRows . '&horderby=' . $this->OrderBy . '&hordertype=' . $this->OrderType . '&hsearchby=' . $this->SearchBy . '&hsearchtxt=' . htmlspecialchars($this->SearchTxt) . '&hpagenumber=' . $this->PageNumber . '&hfilterby=' . $this->FilterBy . '&history=T' . '&mainmodule=' . 'contactusleads';
        ...
        $this->UrlWithpoutSearch = $this->PageName . '?' . 'PageSize=' . $this->PageSize . '&OrderBy=' . $this->OrderBy . '&OrderType=' . $this->OrderType . '&FilterBy=' . $this->FilterBy . '&mainmodule=' . 'contactusleads';
        $this->UrlWithoutSort = $this->PageName . '?' . 'PageSize=' . $this->PageSize . '&NumOfRows=' . $this->NumOfRows . '&SearchBy=' . $this->SearchBy . '&SearchTxt=' . htmlspecialchars_decode(urlencode($this->SearchTxt)) . '&PageNumber=' . $this->PageNumber . '&OrderType=' . $this->OrderType . '&FilterBy=' . $this->FilterBy . '&mainmodule=' . 'contactusleads';
        $this->UrlWithoutPaging = $this->PageName . '?OrderBy=' . $this->OrderBy . '&OrderType=' . $this->OrderType . '&SearchBy=' . $this->SearchBy . '&SearchTxt=' . htmlspecialchars($this->SearchTxt) . '&FilterBy=' . $this->FilterBy . '&mainmodule=' . 'contactusleads';
        $this->UrlWithoutFilter = $this->PageName . '?' . 'PageSize=' . $this->PageSize . '&OrderBy=' . $this->OrderBy . '&OrderType=' . $this->OrderType . '&SearchBy=' . $this->SearchBy . '&SearchTxt=' . $this->SearchTxt . '&mainmodule=' . 'contactusleads';
        $this->AutoSearchUrl = $this->UrlWithPara . "&type=autosearch&SearchByVal=" . $this->SearchByVal . $this->Appendfk_Country_Site . '&mainmodule=' . 'contactusleads';
        $this->AddUrlWithpara = $this->AddPageName . '?' . 'PageSize=' . $this->PageSize . '&NumOfRows=' . $this->NumOfRows . '&OrderBy=' . $this->OrderBy . '&OrderType=' . $this->OrderType . '&SearchBy=' . $this->SearchBy . '&PageNumber=' . $this->PageNumber . '&FilterBy=' . $this->FilterBy . $this->Appendfk_Country_Site . '&mainmodule=' . 'contactusleads';
    }
    ...
    function generateParam($position = 'top') {
        ...
        return array('PageUrl' => MODULE_PAGE_NAME,
            ...
            'tablename' => DB_PREFIX . 'contactusleads',
            'position' => $position,
...
//            'actionUrl' => MODULE_PAGE_NAME . '/add?&PageSize=' . $PageSize . '&fk_Service=' . $_REQUEST['fk_Service'],
    ...
    function SelectAll() {
        ...
        if (!empty($type)) {
            if ($type == 'autosearch') {
                ...
                $this->db->from('contactusleads', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('contactusleads');
        return $rs;
    }
    ...
    function Delete_Row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'contactusleads', 'Name' => varName, 'ModuleintGlcode' => $deletearray[$i], 'Flag' => D, 'Default' => int_id, 'fk_Site' => $SiteSelected);
    ...
    function Export() {
        ...
        $filename = $site_name . "_contactusleads_" . date("dmy-h:i") . ".xls";
        $fileprefix = "contactusleads";
        ...
        foreach ($query as $row) {
            ...
            $gridbind .= "<td valign='top'>" . $row["varCompanyName"] . "</td>";
    ...
    function process() {
        ...
        $varCompanyName = $this->input->get_post('varCompanyName', true);
