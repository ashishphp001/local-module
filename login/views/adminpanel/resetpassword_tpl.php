...
<!--[if gt IE 9]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body class="login_page login_page_v2">
                        ...
                        <div class="uk-width-large-2-3 uk-hidden-medium uk-hidden-small">
                            <div class="login_page_info uk-height-1-1" style="background-image: url('<?php echo ADMIN_MEDIA_URL; ?>assets/img/others/sabri-tuzcu-331970.jpg')">
                                <div class="info_content">
                                    <h1 class="heading_b">Reset Password Page</h1>
                            ...
                            <div class="login_page_forms">
                                <div id="login_card">
                                    <div id="login_form">
                                        ...
                                        <?php
                                        $ErrorData = $this->session->flashdata('ErrorData');

                                        $message = $ErrorData['message'];
                                        $Attribute = array('name' => 'resetpass_FRM', 'id' => 'resetpass_FRM', 'method' => 'POST');

                                        echo form_open(ADMINPANEL_URL . "login/resetpassprocess", $Attribute);
                                        if ($this->input->get_post('token') != '') {
                                            $HiddenValuesArray = array(
                                                "varToken" => $token != '' ? $token : $this->input->get_post('token', true)
                                            );
                                        ...
                                        if (!empty($SuccessData['message'])) {
                                            echo '<div class="md-card-list-wrapper"> <div class="md-card-list">
                            <ul class="hierarchical_slide uk-text-success" id="hierarchical-slide">
                                        ...
                                        <div class="uk-form-row">
                                            <div class="parsley-row">
                                                <label for="varNewPassword">New Password<span class="req">*</span></label>
                                                <input class="md-input" minlength="8" type="password" value="<?php echo $Password; ?>" id="varNewPassword" autocomplete="off" name="varNewPassword" required data-parsley-trigger="change"/>
                                            </div>
                                        </div>
                                        <div class="uk-form-row">
                                            <div class="parsley-row">
                                                <label for="varConfPassword">Confirm Password<span class="req">*</span></label>
                                                <input class="md-input" minlength="8" data-parsley-equalto="#varNewPassword" type="password" value="<?php echo $Password; ?>" id="varConfPassword" autocomplete="off" name="varConfPassword" required data-parsley-trigger="change"/>
                                            </div>
                                        </div>
        ...
        <!-- common functions -->
        <script src="<?php echo ADMIN_MEDIA_URL; ?>assets/js/common.min.js"></script>
        <!-- uikit functions -->
        ...
        <script src="<?php echo ADMIN_MEDIA_URL; ?>bower_components/parsleyjs/dist/parsley.min.js"></script>

        <!--  forms validation functions -->
        <script src="<?php echo ADMIN_MEDIA_URL; ?>assets/js/pages/forms_validation.min.js"></script>
        <script src="<?php echo ADMIN_MEDIA_URL; ?>assets/js/pages/components_animations.min.js"></script>
        <script>
            ...
            altair_form_validation = {
                init: function () {
                    var $formValidate = $('#resetpass_FRM');
                    $formValidate
                            .parsley({
