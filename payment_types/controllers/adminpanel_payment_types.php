...
class Adminpanel_payment_types extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('payment_types_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/payment_types_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/payment_types_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/payment_types/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'payment_types') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/payment_types/' . $file);
