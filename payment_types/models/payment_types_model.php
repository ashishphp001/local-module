...
class payment_types_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countpayment_types();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'heading' => "Manage Payment Types",
            'listImage' => 'add-new-user-icon.png',
            'tablename' => DB_PREFIX . 'payment_types',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('payment_types as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('payment_types');
        return $rs;
    }
    ...
    function Select_Rows($id) {
        ...
        $this->db->from('payment_types As F');
    ...
    function Insert($Files_Name = '') {
        ...
        if ($_FILES['varImage']['name'] != '') {
            $config['upload_path'] = 'upimages/payment_types/images/';
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_types', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_types', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_types', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'payment_types');
    }
