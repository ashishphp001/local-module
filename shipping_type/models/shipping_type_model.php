...
class shipping_type_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countshipping_type();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'heading' => "Manage Shipping Type",
            'listImage' => 'add-new-user-icon.png',
            'tablename' => DB_PREFIX . 'shipping_type',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('shipping_type as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('shipping_type');
        return $rs;
    }
    ...
    function Select_Rows($id) {
        ...
        $this->db->from('shipping_type As F');
    ...
    function Insert($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'shipping_type', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $this->db->update('shipping_type', $data);
        $int_id = $this->input->get_post('ehintglcode');
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'shipping_type', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'shipping_type', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'shipping_type');
    }
