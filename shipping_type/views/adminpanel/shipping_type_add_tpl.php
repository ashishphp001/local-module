    ...
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="<?php echo MODULE_PAGE_NAME; ?>">Manage Shipping Type</a></li>
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Shipping Type - ' . $Row['varName'];
                        } else {
                            echo 'Add Shipping Type';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmshipping_type', 'id' => 'Frmshipping_type', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
            ...
            <div class="md-card-content">
                ...
                <div class="uk-form-row">
                    <div class="uk-width-medium-1-2">
                        <label>Shipping Type Name *</label>
                        <?php
                        $titleBoxdata = array(
                            'name' => 'varName',
                            'id' => 'varName',
