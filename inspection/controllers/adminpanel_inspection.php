...
class Adminpanel_inspection extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('inspection_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/inspection_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/inspection_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/inspection/';                           // MODULE URL
