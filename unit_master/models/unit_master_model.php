...
class unit_master_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countunit_master();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'tablename' => DB_PREFIX . 'unit_master',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('unit_master as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('unit_master');
        return $rs;
    }
    ...
    function Insert($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'unit_master', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'unit_master', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'unit_master', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'unit_master');
    }
