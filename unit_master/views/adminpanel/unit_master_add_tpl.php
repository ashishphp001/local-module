...
<div id="page_content_inner">
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Unit Master - ' . $Row['varName'];
                        } else {
                            echo 'Add Unit Master';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmunit_master', 'id' => 'Frmunit_master', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
