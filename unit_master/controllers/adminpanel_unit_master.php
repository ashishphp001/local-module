...
class Adminpanel_unit_master extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('unit_master_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/unit_master_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/unit_master_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/unit_master/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'unit_master') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/unit_master/' . $file);
