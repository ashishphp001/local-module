        ...
        <div id="page_content_inner">
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><span>Manage Services</span></li>
                </ul>
            </div>
            <h3 class="heading_b uk-margin-bottom">Manage Services</h3>
                                    ...
                                    <tr>      
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            ...
                                            $imagepath = 'upimages/services/images/' . $imagename;
...
//                                         $image_thumb = SITE_PATH. 'upimages/services/images/' . $imagename;
                                            }
                                            if ($imagename != "") {
                                        ...
                                        <td>
                                            ...
                                            ?> 
                                            <div data-val="<?php echo $Row['chrPublish'] == 'Y' ? true : false; ?>" id="button-<?php echo $Row['int_id'] ?>" class="buttononoff"  tablename="<?php echo DB_PREFIX . 'services' ?>" field="chrPublish" data-id="<?php echo $Row['int_id'] ?>" ></div>
                                        </td>
