...
class Adminpanel_services extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('services_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/services_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/services_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/services/';                           // MODULE URL
...
//        echo "Ad";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'services') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/services/' . $file);
