...
class Adminpanel_bulkemail extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();

        $this->load->model('bulkemail_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/bulkemail_tpl';                   // MODULE MAIN VIEW
