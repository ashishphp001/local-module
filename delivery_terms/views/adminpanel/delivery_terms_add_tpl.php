    ...
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="<?php echo MODULE_PAGE_NAME; ?>">Manage Units Master</a></li>
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Delivery Terms - ' . $Row['varName'];
                        } else {
                            echo 'Add Delivery Terms';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmdelivery_terms', 'id' => 'Frmdelivery_terms', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
