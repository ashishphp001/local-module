...
class Adminpanel_designation extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('designation_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/designation_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/designation_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/designation/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'designation') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/designation/' . $file);
