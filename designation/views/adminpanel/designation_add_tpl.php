    ...
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="<?php echo MODULE_PAGE_NAME; ?>">Manage Designation</a></li>
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Designation - ' . $Row['varName'];
                        } else {
                            echo 'Add Designation';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmdesignation', 'id' => 'Frmdesignation', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
