        ...
        <div id="page_content_inner">
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><span>Manage Designation</span></li>
                </ul>
            </div>
            <h3 class="heading_b uk-margin-bottom">Manage Designation</h3>
                                        ...
                                        <?php if ($permissionArry['Publish/Export'] == 'Y') { ?>   
                                            <td>
                                                <div class="title-text settings-setter">
                                                    ...
                                                    ?> 
                                                    <div data-val="<?php echo $Row['chrPublish'] == 'Y' ? true : false; ?>" id="button-<?php echo $Row['int_id'] ?>" class="buttononoff"  tablename="<?php echo DB_PREFIX . 'designation' ?>" field="chrPublish" data-id="<?php echo $Row['int_id'] ?>" ></div>
                                                </div>
                                            </td>
                                        <?php } ?>   
