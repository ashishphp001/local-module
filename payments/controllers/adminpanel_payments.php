...
class Adminpanel_payments extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('payments_model', 'module_model');      // MODULE MODEL
        $this->main_tpl = 'adminpanel/payments_tpl';                 // MODULE MAIN VIEW  
        $this->module_url = base_url() . 'adminpanel/payments/';               // MODULE URL
    ...
    public function index() {
        ...
        $this->viewData['paymentsTab'] = true;
