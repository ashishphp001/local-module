...
class Adminpanel_chat_support extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('chat_support_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/chat_support_tpl';                   // MODULE MAIN VIEW
        $this->add_tpl = 'adminpanel/chat_support_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/chat_support/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function getmessage() {
        $data = $this->Module_Model->getmessage();
        header("Content-type:application/json");
        echo json_encode($data);
    }
    public function addmessage() {
        $this->Module_Model->addmessage();
    }
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'chat_support') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/chat_support/' . $file);
