<script type="text/javascript">
    ...
    function check_remote_file_exist() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>adminpanel/chat_support/CheckRemoteFile",
...
<div id="page_content_inner">
    <div id="page_content">
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmchat_support', 'id' => 'Frmchat_support', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
                    ...
                    <div class="uk-form-row">
                        <div class="uk-width-medium-1-2">
                            ...
                            $DOBoxdata1 = array(
                                ...
                                'maxlength' => '3',
                                'class' => 'md-input',
                                'onkeypress' => 'return KeycheckOnlyNumeric(chat_support);',
                            );
