...
class Adminpanel_business_type extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('business_type_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/business_type_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/business_type_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/business_type/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'business_type') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/business_type/' . $file);
