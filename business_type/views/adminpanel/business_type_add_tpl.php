...
<div id="page_content_inner">
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Business Type - ' . $Row['varName'];
                        } else {
                            echo 'Add Business Type';
                        }
                        ?>
                    </span></li>
            </ul>
      ...
      <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmbusiness_type', 'id' => 'Frmbusiness_type', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
