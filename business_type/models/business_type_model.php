...
class business_type_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countbusiness_type();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'tablename' => DB_PREFIX . 'business_type',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('business_type as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('business_type');
        return $rs;
    }
    ...
    function Select_Rows($id) {
        ...
        $this->db->from('business_type As F');
    ...
    function Insert($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'business_type', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'business_type', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'business_type', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'business_type');
    }
