                ...
                <div class="uk-slidenav-position" data-uk-slider="{infinite: false}">
                    <div class="uk-slider-container">
                        <ul class="uk-slider uk-grid-width-small-1-6 top_bar_nav" id="notes_grid_filter">
                            ...
                            <li data-uk-filter="Admin">
                                <a href="javascript:;"><span class="uk-badge uk-badge-default">Admin</span></a>
                            </li>
                            <li data-uk-filter="Supplier">
                                <a href="javascript:;"><span class="uk-badge uk-badge-warning">Supplier</span></a>
                            </li>
                            <li data-uk-filter="Buyer">
                                <a href="javascript:;"><span class="uk-badge uk-badge-danger">Buyer</span></a>
                            </li>
                            <li data-uk-filter="Personal">
                                <a href="javascript:;"><span class="uk-badge uk-badge-success">Personal</span></a>
                            </li>
                            <li data-uk-filter="Employee">
                                <a href="javascript:;"><span class="uk-badge uk-badge-primary">Employee</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div {{#exists labels}}data-uk-filter="{{#each labels }}{{#ifCond @key '>' 0}},{{/ifCond}}{{ text_safe }}{{/each}}"{{/exists}}>
            <div class="md-card {{#exists color}}{{color}}{{/exists}}">
                <div class="uk-position-absolute uk-position-top-right uk-margin-small-right uk-margin-small-top">
                    <a href="javascript:;" class="note_action_remove" onclick="return deletenote({{int_id}})"><i class="md-icon material-icons">&#xE5CD;</i></a>
                    ...
                    {{#exists checklist}}
                        <ul class="uk-list">
                            ...
                            <li class="uk-margin-small-top">
                                <input disabled  type="checkbox" id="checkbox_{{#if id}}{{id}}{{else}}{{@../index}}_{{@index}}{{/if}}" data-md-icheck {{#if checked}}checked{{/if}}/>
                                <label disabled style="color: black !important;" for="checkbox_{{#if id}}{{id}}{{else}}{{@../index}}_{{@index}}{{/if}}" class="inline-label">{{title}}</label>
                            </li>
                            {{/each}}
                        </ul>
                    {{/exists}}
