...
class payment_terms_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countpayment_terms();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'tablename' => DB_PREFIX . 'payment_terms',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('payment_terms as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('payment_terms');
        return $rs;
    }
    ...
    function Select_Rows($id) {
        ...
        $this->db->from('payment_terms As F');
    ...
    function Insert($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_terms', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_terms', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'payment_terms', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'payment_terms');
    }
