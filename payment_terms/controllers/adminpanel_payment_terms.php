...
class Adminpanel_payment_terms extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('payment_terms_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/payment_terms_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/payment_terms_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/payment_terms/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'payment_terms') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/payment_terms/' . $file);
