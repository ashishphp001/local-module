    ...
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="<?php echo MODULE_PAGE_NAME; ?>">Manage Payment Terms</a></li>
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Payment Terms - ' . $Row['varName'];
                        } else {
                            echo 'Add Payment Terms';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmpayment_terms', 'id' => 'Frmpayment_terms', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
