...
class Adminpanel_logistic extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('logistic_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/logistic_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/logistic_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/logistic/';                           // MODULE URL
