...
class Adminpanel_eventleads extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('eventleads_model', 'module_model');      // MODULE MODEL
        $this->main_tpl = 'adminpanel/eventleads_tpl';                 // MODULE MAIN VIEW  
        $this->module_url = base_url() . 'adminpanel/eventleads/';               // MODULE URL
    ...
    public function index() {
        ...
        $this->viewData['eventleadsTab'] = true;
    ...
    public function download_pdf() {
        ...
        $data = file_get_contents(base_url() . 'upimages/eventleads/' . $file);
