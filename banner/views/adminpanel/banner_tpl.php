        ...
        <div id="page_content_inner">
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><span>Manage Banners</span></li>
                </ul>
            </div>
            <h3 class="heading_b uk-margin-bottom">Manage Banners</h3>
                            ...
                            if (!empty($ShowAllPagesRecords)) {
                                foreach ($ShowAllPagesRecords as $Row) {
                                    ...
                                    <tr>      
                                        ...
                                        <td>
                                            <div><?php echo $Row['varTitle']; ?></div>
                                        </td>
                                        <td>

                                            <?php
                                            $imagename = $Row['varImage'];
                                            $imagepath = 'upimages/banner/images/' . $imagename;
                                            if (file_exists($imagepath) && $Row['varImage'] != '') {
                                                $image_thumb = image_thumb($imagepath, ICON_SIZE_WIDTH, ICON_SIZE_HEIGHT);
                                                $image_detail_thumb = SITE_PATH . 'upimages/banner/images/' . $imagename;
                                            }
                                            if ($imagename != "") {
                                        ...
                                        <td>
                                            ...
                                            if($Row['Chr_Banner_Type']=='I'){
                                                echo "Inner Banner";
                                            }else if($Row['Chr_Banner_Type']=='S'){
                                                echo "Supplier Banner";
                                            }else{
                                                echo "Home Banner";
                                            }
                                            ?></div>
...
<!--                                        <td>
                                            <div>
                                                <?php if ($Row['Chr_Banner_Type'] == 'H' || $Row['Chr_Banner_Type']=='S') { ?>
                                                    <?php
                                                    ...
                                                    <?php } else { ?>
                                                        &nbsp;&nbsp;<img src="<?php echo ADMIN_MEDIA_URL_DEFAULT; ?>images/arrow-up.png" title="Move Up" style="cursor:pointer;"  onclick="DisplayOrderSpinner('displayorder<?php echo $RowCountPgaes ?>', 'up', '<?php echo $this->Module_Model->module_url ?>', '<?php echo $this->Module_Model->UrlWithoutSort ?>&orderby=intDisplayOrder', '<?php echo $Row['int_id'] ?>', '', '', '', '<?php echo $Row['Chr_Banner_Type']; ?>')" border="0" />
                                                    <?php } ?>                                                                        
                                                    <?php
                                                    $banner = $this->Module_Model->Homebannercount();
                                                    ?>
                                                    <?php // }  ?>
                                                    <?php if ($Row['intDisplayOrder'] < $banner) { ?>
                                        ...
                                        <td>
                                            <div class="title-text settings-setter">
                                                ...
                                                ?> 
                                                <div data-val="<?php echo $Row['chrPublish'] == 'Y' ? true : false; ?>" id="button-<?php echo $Row['int_id'] ?>" class="buttononoff"  tablename="<?php echo DB_PREFIX . 'banner' ?>" field="chrPublish" data-id="<?php echo $Row['int_id'] ?>" ></div>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
