<script type="text/javascript">
    ...
    function check_remote_file_exist() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>adminpanel/request_callback/CheckRemoteFile",
    ...
    <div id="page_content">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="<?php echo MODULE_PAGE_NAME; ?>">Manage Request Call Back</a></li>
                <li><span>
                        <?php
                        if (!empty($eid)) {
                            echo 'Edit Request Call Back - ' . $Row['varName'];
                        } else {
                            echo 'Add Request Call Back';
                        }
                        ?>
                    </span></li>
            </ul>
       ...
       <?php
        ...
        <div class="clear"></div>
        <?php
        $attributes = array('name' => 'Frmrequest_callback', 'id' => 'Frmrequest_callback', 'enctype' => 'multipart/form-data', 'class' => 'enquiry_form');
                    ...
                    <div class="uk-form-row">
                        <div class="uk-width-medium-1-2">
                            ...
                            $DOBoxdata1 = array(
                                ...
                                'maxlength' => '3',
                                'class' => 'md-input',
                                'onkeypress' => 'return KeycheckOnlyNumeric(request_callback);',
                            );
