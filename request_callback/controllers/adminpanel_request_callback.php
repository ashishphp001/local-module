...
class Adminpanel_request_callback extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('request_callback_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/request_callback_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/request_callback_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/request_callback/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updateStatus() {
        $this->Module_Model->updateStatus();
    }
    ...
    public function checkdata() {
        $data = $this->Module_Model->checkdata();
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'request_callback') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/request_callback/' . $file);
