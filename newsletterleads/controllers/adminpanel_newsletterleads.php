...
class Adminpanel_newsletterleads extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('newsletterleads_model', 'module_model');      // MODULE MODEL
        $this->main_tpl = 'adminpanel/newsletterleads_tpl';                 // MODULE MAIN VIEW  
        $this->module_url = base_url() . 'adminpanel/newsletterleads/';               // MODULE URL
    ...
    public function index() {
        ...
        $this->viewData['newsletterleadsTab'] = true;
    ...
    public function download_pdf() {
        ...
        $data = file_get_contents(base_url() . 'upimages/newsletterleads/' . $file);
