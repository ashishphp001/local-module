                        ...
                        foreach ($ShowAllPagesRecords as $Row) {
                            ...
                            <tr>      
                                ...
                                <td align="center" valign="top">
                                    ...
                                    $imagepath = 'upimages/team/images/' . $imagename;
...
//                                         $image_thumb = SITE_PATH. 'upimages/team/images/' . $imagename;
                                    }
                                    if ($imagename != "") {
                                ...
                                <td align="center" valign="top">
                                    <div class="title-text settings-setter">
                                        ...
                                        ?> 
                                        <div data-val="<?php echo $Row['chrPublish'] == 'Y' ? true : false; ?>" id="button-<?php echo $Row['int_id'] ?>" class="buttononoff"  tablename="<?php echo DB_PREFIX . 'team' ?>" field="chrPublish" data-id="<?php echo $Row['int_id'] ?>" ></div>
                                    </div>
                                </td>
