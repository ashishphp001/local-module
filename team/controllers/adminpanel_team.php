...
class Adminpanel_team extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('team_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/team_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/team_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/team/';                           // MODULE URL
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'team') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/team/' . $file);
