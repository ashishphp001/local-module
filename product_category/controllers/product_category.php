...
class product_category extends Front_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('product_category_model', 'Module_Model');
        $this->module_url = FRONT_MODULE_URL;
        $this->main_tpl = 'front/product_category_tpl';
    }
    ...
    public function index() {
        ...
        if ($this->input->get_post('ajax', TRUE) == 'Y') {
            ...
            $this->viewData['ContentPanel'] = 'front/product_category_tpl';
        }
        $this->load_view();
    }

    public function getCategorySearch() {
        echo $this->Module_Model->getCategorySearch();
    }

    public function details($id) {
        $CurrentPageData = $this->common_model->getPageData_Seo(RECORD_ID, "product_category");
        ...
        $Seo_array['description'] = $CurrentPageData['varMetaDescription'];
        $this->common_model->get_metadata($Seo_array);
        $this->viewData['ContentPanel'] = 'front/product_category_detail_tpl';
