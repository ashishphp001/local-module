...
class Adminpanel_plan_feature extends AdminPanel_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('plan_feature_model', 'Module_Model');           // MODULE MODEL
        $this->main_tpl = 'adminpanel/plan_feature_tpl';                   // MODULE MAIN VIEW
        $this->share_tpl = 'adminpanel/shareoption_tpl';
        $this->add_tpl = 'adminpanel/plan_feature_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/plan_feature/';                           // MODULE URL
...
//      echo "here";exit;
    ...
    public function updatepublish() {
        if ($this->input->get_post('tablename', true) == DB_PREFIX . 'plan_feature') {
...
//            print_r($this->viewData['rec']);exit;
    ...
    public function download() {
        ...
        $data = file_get_contents(base_url() . 'upimages/plan_feature/' . $file);
