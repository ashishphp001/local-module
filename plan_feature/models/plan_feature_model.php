...
class plan_feature_model extends CI_Model {
    ...
    function initialize($flag = '') {
        ...
        if ($flag == 'Y') {
            $this->NumOfRows = $this->Countplan_feature();
    ...
    function generateParam($position = 'top') {
        ...
        return array(
            ...
            'tablename' => DB_PREFIX . 'plan_feature',
            'position' => $position,
    ...
    function SelectAll() {
        ...
        $this->db->from('plan_feature as F', false);
    ...
    function CountRows() {
        ...
        $rs = $this->db->count_all_results('plan_feature');
        return $rs;
    }
    ...
    function Select_Rows($id) {
        ...
        $this->db->from('plan_feature As F');
    ...
    function Insert($Files_Name = '') {
        ...
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'plan_feature', 'Name' => 'varName', 'ModuleintGlcode' => $id, 'Flag' => 'I', 'Default' => 'int_id');
    ...
    function update($Files_Name = '') {
        ...
        $this->db->update('plan_feature', $data);
        $int_id = $this->input->get_post('ehintglcode');
        $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'plan_feature', 'Name' => 'varName', 'ModuleintGlcode' => $int_id, 'Flag' => 'U', 'Default' => 'int_id');
        $this->mylibrary->insertinlogmanager($ParaArray);
    }
    ...
    function delete_row() {
        ...
        for ($i = 0; $i < $totaldeletedrecords; $i++) {
            ...
            $ParaArray = array('ModelId' => MODULE_ID, 'TableName' => DB_PREFIX . 'plan_feature', 'Name' => 'varName', 'ModuleintGlcode' => $deletearray[$i], 'Flag' => 'D', 'Default' => 'int_id');
            $this->mylibrary->insertinlogmanager($ParaArray);
        }
        $this->mylibrary->set_Int_DisplayOrder_sequence(DB_PREFIX . 'plan_feature');
    }
