                        ...
                        <div class="inquiry-form">
                            <div class="fl"> 
                                ...
                                <div class="fl mgl10">
                                    ...
                                    $DOBoxdata1 = array(
                                        ...
                                        'maxlength' => '3',
                                        'class' => 'form-control',
                                        'onkeypress' => 'return KeycheckOnlyNumeric(users);',
                                    );
                            ...
                            <div class="fl title-w" > 
                                ...
                                <div class="fl mgl5 tooltip" style="position: relative;" title="<strong><?php echo "Note: Please select 'Yes' if you want to display / activate this record. Otherwise please select 'NO'" ?></strong>" >
                                    <img style="vertical-align:middle;margin-left:5px" width="16" height="16" alt="" onmouseout="hidediv('dvhlpvarwebsite');" onmouseover="showDiv(users, 'dvhlpvarwebsite')" src="<?php echo GLOBAL_ADMIN_IMAGES_PATH; ?>/help.png">
                                </div>
                            </div>
                        </div>
                        <div class="spacer10"></div>
